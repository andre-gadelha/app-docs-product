...
class Config:
    ...
    TEMPLATE_RELATORIO_ENTREGA_DOCX = os.path.join(TEMPLATE_DOCX_DIR, 'relatorio_entrega', 'template_entrega.docx')
    LEGACY_TEMPLATE_DOCX = os.path.join(basedir, "Proposta OS 'AnoOS'-'NúmeroOs' - 'TítuloOS'.docx")
    LEGACY_TEMPLATE_RELATORIO_ENTREGA_DOCX = os.path.join(basedir, 'template_entrega.docx')
